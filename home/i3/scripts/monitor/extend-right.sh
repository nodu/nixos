...
xrandr \
	--output "$EXT" --primary --mode 3440x1440 --rate 120 --pos 2256x0 --rotate normal \
	--output eDP-1 --mode 2256x1504 --rate 60 --pos 0x0 --rotate normal --scale 1x1 \
	$OFF_ARGS

dunstify "External Monitor: Right (120Hz)"
