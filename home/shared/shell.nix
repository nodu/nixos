...

{
  home.sessionVariables = {
    ...
    LC_ALL = "en_US.UTF-8";
    EDITOR = "nvim";
    # --mouse: less claims mouse reporting so tmux passes wheel events through
    # to it instead of entering copy-mode (which can't scroll a -X pager).
    PAGER = "less -FirSwX --mouse --wheel-lines=3";
